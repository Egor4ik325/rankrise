    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(editable=False, help_text='The name of the product is set only once when creating', max_length=50, unique=True, verbose_name='name')),
                ...
                ('price', models.CharField(choices=[('F', 'Free'), ('P', 'Paid'), ('O', 'Open-Source')], default='F', max_length=1, verbose_name='price')),
            ],
            options={
